 ...
 */
final class Version20251124123647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE age_autorise age_autorise INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE age_autorise age_autorise TINYINT(1) NOT NULL');
    }
}
