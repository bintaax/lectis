 ...
 */
final class Version20251126142917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livres (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, auteur VARCHAR(255) NOT NULL, editeur VARCHAR(255) NOT NULL, resume LONGTEXT NOT NULL, date_publication DATETIME NOT NULL, nb_pages INT NOT NULL, prix NUMERIC(10, 2) NOT NULL, photo VARCHAR(255) NOT NULL, disponibilite TINYINT(1) NOT NULL, age_autorise INT NOT NULL, is_best_seller TINYINT(1) DEFAULT NULL, genre_id INT DEFAULT NULL, INDEX IDX_927187A44296D31F (genre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
