 ...
 */
final class Version20251205150952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, total DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, paiement VARCHAR(50) NOT NULL, utilisateurs_id INT DEFAULT NULL, ligne_commande_id INT DEFAULT NULL, INDEX IDX_35D4282C1E969C5 (utilisateurs_id), INDEX IDX_35D4282CE10FEE63 (ligne_commande_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
